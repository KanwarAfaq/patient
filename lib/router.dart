import 'package:patient/qrcode_reader_page.dart';
import 'package:patient/service/configuration_service.dart';
import 'package:patient/wallet_create_page.dart';
import 'package:patient/wallet_import_page.dart';
import 'package:patient/wallet_main_page.dart';
import 'package:patient/wallet_transfer_page.dart';
  ...
  return {
    ...
    '/transfer': (BuildContext context) => WalletTransferProvider(
          ...
          builder: (context, store) =>
              WalletTransferPage(title: 'Send Transaction'),
        ),
